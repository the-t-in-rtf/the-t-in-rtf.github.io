...
<a name='L597'></a><a href='#L597'>597</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (!gpii.oauth2.dbDataStore) {
<span class="cstat-no" title="statement not covered" >    require("./DbDataStoreUtils.js");</span>
}
&nbsp;
