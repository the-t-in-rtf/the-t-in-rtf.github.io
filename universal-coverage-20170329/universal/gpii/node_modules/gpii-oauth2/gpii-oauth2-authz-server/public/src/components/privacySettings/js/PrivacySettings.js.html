...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/public/src/components/privacySettings/js/PrivacySettings.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../../../../../index.html">all files</a> / <a href="index.html">universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/public/src/components/privacySettings/js/</a> PrivacySettings.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
var gpii = gpii || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
(function ($, fluid) {
    "use strict";
&nbsp;
...
&nbsp;
    ...
    gpii.oauth2.privacySettings.reload = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        window.location.reload(true);</span>
    };
&nbsp;
