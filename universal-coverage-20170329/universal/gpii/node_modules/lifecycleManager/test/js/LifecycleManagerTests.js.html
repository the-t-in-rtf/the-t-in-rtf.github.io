...
<a name='L860'></a><a href='#L860'>860</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    gpii.tests.lifecycleManager.mockSettingsHandler = {
        ...
        get: <span class="fstat-no" title="function not covered" >function (data) {</span>
...
&nbsp;
    gpii.tests.lifecycleManager.runTests = function () {
        jqUnit.module("Lifecycle Manager", <span class="fstat-no" title="function not covered" >function () {</span>
