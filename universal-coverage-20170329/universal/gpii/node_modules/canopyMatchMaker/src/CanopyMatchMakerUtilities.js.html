...
var gpii = gpii || <span class="branch-1 cbranch-no" title="branch not covered" >fluid.registerNamespace("gpii");</span>
&nbsp;
...
gpii.canopyMatchMaker.utils.compareFitness = function (solA, solB) {
    ...
    for (; ; ++i) {
        ...
        if (endA || endB) {
            return endA &amp;&amp; endB ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: (endB ? -1 : 1);
        }
...
gpii.canopyMatchMaker.utils.ISO24751.ontologicalMetric = function (path, model) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (segs[0] === "applications" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >fluid.get(model, ["applications", segs[1]]) === undefined)</span> {
