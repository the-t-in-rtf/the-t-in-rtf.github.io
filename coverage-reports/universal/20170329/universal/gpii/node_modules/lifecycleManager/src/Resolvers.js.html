        ...
        return function (parsed) {
            ...
            return !resolver ? undefined : (
                typeof(resolver) === "function" ?
                    resolver(parsed.path) : <span class="branch-1 cbranch-no" title="branch not covered" >fluid.get(resolver, parsed.path))</span>;
        };
    };
&nbsp;
    ...
    gpii.combineFetchers = function (main, fallback) {
        ...
        } : <span class="branch-1 cbranch-no" title="branch not covered" >main;</span>
    };
&nbsp;
...
&nbsp;
    gpii.lifecycleManager.environmentResolver = <span class="fstat-no" title="function not covered" >function (name) {</span>
