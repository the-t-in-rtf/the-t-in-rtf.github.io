...
&nbsp;
    gpii.tests.matchMakerUtilities.disposeFromPriority.assertSolutionDisposition = <span class="fstat-no" title="function not covered" >function (input, solId, expDisposition) {</span>
<span class="cstat-no" title="statement not covered" >        var msg = "Expecting solution " + solId + " to have disposition: " + expDisposition;</span>
