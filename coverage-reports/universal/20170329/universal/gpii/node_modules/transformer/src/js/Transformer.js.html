...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (settingsHandler.capabilitiesTransformations) {
...
&nbsp;
    gpii.transformer.booleanToNumber = <span class="fstat-no" title="function not covered" >function (value) {</span>
