...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/webTests/components/privacySettings/js/PrivacySettingsDialogUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../../../../index.html">all files</a> / <a href="index.html">universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/webTests/components/privacySettings/js/</a> PrivacySettingsDialogUtils.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    gpii.tests.oauth2.privacySettings.assertDialog = function (that, dialogState) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (dialogState === "closed") {
