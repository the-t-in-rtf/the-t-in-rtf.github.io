  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">38.62% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>56/145</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L595'></a><a href='#L595'>595</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
var fluid = fluid || <span class="branch-1 cbranch-no" title="branch not covered" >require("infusion"),</span>
    ...
    uuid = uuid || <span class="branch-1 cbranch-no" title="branch not covered" >require("node-uuid");</span>
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (!gpii.oauth2.errors) {
<span class="cstat-no" title="statement not covered" >    require("../../gpii-oauth2-utilities/src/OAuth2Utilities.js");</span>
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (emptyFields.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.missingInput, {fieldName: emptyFields.join(" &amp; ")});</span>
...
&nbsp;
    ...
    fluid.each(valueNotEmpty, function (fieldName) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (obj[fieldName] === undefined) {
<span class="cstat-no" title="statement not covered" >            emptyFields.push(fieldName);</span>
        }
    });
    return emptyFields;
};
...
*/
gpii.oauth2.dbDataStore.addRecord = <span class="fstat-no" title="function not covered" >function (dataSource, docType, idName, data) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = fluid.promise();</span>
...
<span class="cstat-no" title="statement not covered" >        var directModel = {};</span>
<span class="cstat-no" title="statement not covered" >        directModel[idName] = uuid.v4();</span>
<span class="cstat-no" title="statement not covered" >        fluid.extend(data, {type: docType});</span>
<span class="cstat-no" title="statement not covered" >        var finalDirectModel = fluid.extend(true, {}, dataSource.options.directModel, directModel);</span>
<span class="cstat-no" title="statement not covered" >        promise = dataSource.set(finalDirectModel, data);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.missingDoc, {docName: docType});</span>
...
*/
gpii.oauth2.dbDataStore.updateRecord = <span class="fstat-no" title="function not covered" >function (dataSource, docType, idName, data) {</span>
<span class="cstat-no" title="statement not covered" >    var directModel = {};</span>
<span class="cstat-no" title="statement not covered" >    directModel[idName] = data.id;</span>
<span class="cstat-no" title="statement not covered" >    fluid.extend(data, {type: docType});</span>
<span class="cstat-no" title="statement not covered" >    delete data.id;</span>
<span class="cstat-no" title="statement not covered" >    var finalDirectModel = fluid.extend(true, {}, dataSource.options.directModel, directModel);</span>
<span class="cstat-no" title="statement not covered" >    var promise = dataSource.set(finalDirectModel, data);</span>
<span class="cstat-no" title="statement not covered" >    return promise;</span>
};
&nbsp;
/**
 ...
 */
gpii.oauth2.dbDataStore.verifyMissingDoc = <span class="fstat-no" title="function not covered" >function (inputPromise, input, docType, allowUndefinedValue) {</span>
<span class="cstat-no" title="statement not covered" >    allowUndefinedValue = allowUndefinedValue || false;</span>
<span class="cstat-no" title="statement not covered" >    var promiseTogo = fluid.promise();</span>
<span class="cstat-no" title="statement not covered" >    inputPromise.then(<span class="fstat-no" title="function not covered" >function (value) {</span></span>
<span class="cstat-no" title="statement not covered" >        var isValueValid = allowUndefinedValue ? value || value === undefined : value;</span>
<span class="cstat-no" title="statement not covered" >        if (isValueValid) {</span>
            // Save both the input parameter and the resolved value of the inputPromise for their further use in following processes
<span class="cstat-no" title="statement not covered" >            var valueObj = {};</span>
<span class="cstat-no" title="statement not covered" >            valueObj[docType] = value;</span>
<span class="cstat-no" title="statement not covered" >            var combined = fluid.extend({}, input, valueObj);</span>
<span class="cstat-no" title="statement not covered" >            promiseTogo.resolve(combined);</span>
        } else {
            // Throw error indicating which document type is missing
<span class="cstat-no" title="statement not covered" >            var error = gpii.oauth2.composeError(gpii.oauth2.errors.missingDoc, {docName: gpii.oauth2.dbDataStore.docTypes[docType]});</span>
<span class="cstat-no" title="statement not covered" >            promiseTogo.reject(error);</span>
        }
 ...
 * }
 */
gpii.oauth2.dbDataStore.updateAuthDecision = <span class="fstat-no" title="function not covered" >function (that, userId, authDecisionData) {</span>
<span class="cstat-no" title="statement not covered" >    var input = {</span>
        userId: userId,
        authDecisionData: authDecisionData
    };
<span class="cstat-no" title="statement not covered" >    return fluid.promise.fireTransformEvent(that.events.onUpdateAuthDecision, {inputArgs: input});</span>
};
&nbsp;
/**
 ...
 */
gpii.oauth2.dbDataStore.authDecisionExists = <span class="fstat-no" title="function not covered" >function (findAuthDecisionById, input) {</span>
<span class="cstat-no" title="statement not covered" >    var authDecisionId = input.inputArgs.authDecisionId ? input.inputArgs.authDecisionId : input.inputArgs.authDecisionData.id;</span>
<span class="cstat-no" title="statement not covered" >    var authDecisionPromise = findAuthDecisionById(authDecisionId);</span>
<span class="cstat-no" title="statement not covered" >    return gpii.oauth2.dbDataStore.verifyMissingDoc(authDecisionPromise, input, "authDecision");</span>
};
&nbsp;
/**
 ...
 * @return {Promise} see gpii.oauth2.dbDataStore.verifyMissingDoc() for details
 */
gpii.oauth2.dbDataStore.validateGpiiToken = <span class="fstat-no" title="function not covered" >function (findGpiiToken, authDecisionRecord) {</span>
<span class="cstat-no" title="statement not covered" >    var gpiiTokenPromise = findGpiiToken(authDecisionRecord.authDecision.gpiiToken);</span>
<span class="cstat-no" title="statement not covered" >    return gpii.oauth2.dbDataStore.verifyMissingDoc(gpiiTokenPromise, authDecisionRecord, "gpiiToken");</span>
};
&nbsp;
/**
 ...
 */
gpii.oauth2.dbDataStore.doUpdate = <span class="fstat-no" title="function not covered" >function (dataSource, gpiiTokenRecord) {</span>
<span class="cstat-no" title="statement not covered" >    var inputUserId = gpiiTokenRecord.inputArgs.userId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (gpiiTokenRecord.gpiiToken.userId === inputUserId) {</span>
        // updateAuthDecision() provides "authDecisionData" while revokeAuthDecision() provides "dataProcessFunc" to turn on "revoked"
<span class="cstat-no" title="statement not covered" >        var authDecision = gpiiTokenRecord.inputArgs.authDecisionData ?</span>
            gpiiTokenRecord.inputArgs.authDecisionData :
            gpiiTokenRecord.inputArgs.dataProcessFunc(gpiiTokenRecord.authDecision);
<span class="cstat-no" title="statement not covered" >        return gpii.oauth2.dbDataStore.updateRecord(dataSource, gpii.oauth2.dbDataStore.docTypes.authDecision, "id", authDecision);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        var promiseTogo = fluid.promise();</span>
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.unauthorizedUser, {userId: inputUserId});</span>
<span class="cstat-no" title="statement not covered" >        promiseTogo.reject(error);</span>
<span class="cstat-no" title="statement not covered" >        return promiseTogo;</span>
    }
};
 ...
 */
gpii.oauth2.dbDataStore.revokeAuthDecision = <span class="fstat-no" title="function not covered" >function (that, revokeFunc, userId, authDecisionId) {</span>
<span class="cstat-no" title="statement not covered" >    var input = {</span>
        userId: userId,
        authDecisionId: authDecisionId,
        dataProcessFunc: revokeFunc
    };
<span class="cstat-no" title="statement not covered" >    return fluid.promise.fireTransformEvent(that.events.onRevokeAuthDecision, {inputArgs: input});</span>
};
&nbsp;
/**
 ...
 */
gpii.oauth2.dbDataStore.setRevoke = <span class="fstat-no" title="function not covered" >function (data) {</span>
<span class="cstat-no" title="statement not covered" >    data.revoked = true;</span>
 ...
 */
gpii.oauth2.dbDataStore.findAuthorizedClientsByGpiiTokenPostProcess = <span class="fstat-no" title="function not covered" >function (data) {</span>
<span class="cstat-no" title="statement not covered" >    var records = [];</span>
<span class="cstat-no" title="statement not covered" >    fluid.each(data, <span class="fstat-no" title="function not covered" >function (row) {</span></span>
<span class="cstat-no" title="statement not covered" >        var oneResult = {</span>
...
<span class="cstat-no" title="statement not covered" >        records.push(oneResult);</span>
    });
 ...
 */
gpii.oauth2.dbDataStore.saveAuthCode = <span class="fstat-no" title="function not covered" >function (saveDataSource, authDecisionId, code) {</span>
<span class="cstat-no" title="statement not covered" >    var promiseTogo = fluid.promise();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var emptyFields = gpii.oauth2.dbDataStore.filterEmptyFields(data, ["authDecisionId", "code"]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (emptyFields.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.missingInput, {fieldName: emptyFields.join(" &amp; ")});</span>
<span class="cstat-no" title="statement not covered" >        promiseTogo.reject(error);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        promiseTogo = gpii.oauth2.dbDataStore.addRecord(saveDataSource, gpii.oauth2.dbDataStore.docTypes.authCode, "id", data);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return promiseTogo;</span>
};
 ...
 */
gpii.oauth2.dbDataStore.findAuthByCodePostProcess = <span class="fstat-no" title="function not covered" >function (data) {</span>
<span class="cstat-no" title="statement not covered" >    if (data.doc.revoked === false) {</span>
...
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.unauthorizedAuthCode, {code: data.id});</span>
 ...
 */
gpii.oauth2.dbDataStore.addClientCredentialsToken = <span class="fstat-no" title="function not covered" >function (saveDataSource, clientCredentialsTokenData) {</span>
<span class="cstat-no" title="statement not covered" >    var promiseTogo = fluid.promise();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (clientCredentialsTokenData === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        var error = gpii.oauth2.composeError(gpii.oauth2.errors.missingInput, {fieldName: "clientCredentialsTokenData"});</span>
<span class="cstat-no" title="statement not covered" >        promiseTogo.reject(error);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        var data = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        promiseTogo = gpii.oauth2.dbDataStore.addRecord(saveDataSource, gpii.oauth2.dbDataStore.docTypes.clientCredentialsToken, "id", data);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return promiseTogo;</span>
};
 ...
 */
gpii.oauth2.dbDataStore.revokeClientCredentialsToken = <span class="fstat-no" title="function not covered" >function (that, clientCredentialsTokenId) {</span>
<span class="cstat-no" title="statement not covered" >    return fluid.promise.fireTransformEvent(that.events.onRevokeClientCredentialsToken, clientCredentialsTokenId);</span>
};
&nbsp;
/**
 ...
 */
gpii.oauth2.dbDataStore.doRevokeClientCredentialsToken = <span class="fstat-no" title="function not covered" >function (saveDataSource, clientCredentialsTokenRecord) {</span>
<span class="cstat-no" title="statement not covered" >    var promiseTogo = fluid.promise();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (clientCredentialsTokenRecord === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        promiseTogo.resolve(undefined);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        var data = fluid.copy(clientCredentialsTokenRecord);</span>
<span class="cstat-no" title="statement not covered" >        data.revoked = true;</span>
<span class="cstat-no" title="statement not covered" >        promiseTogo = gpii.oauth2.dbDataStore.updateRecord(saveDataSource, gpii.oauth2.dbDataStore.docTypes.clientCredentialsToken, "id", data);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return promiseTogo;</span>
};
