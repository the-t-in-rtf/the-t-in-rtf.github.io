...
&nbsp;
gpii.oauth2.composeError = <span class="fstat-no" title="function not covered" >function (error, termMap) {</span>
<span class="cstat-no" title="statement not covered" >    var err = fluid.copy(error);</span>
<span class="cstat-no" title="statement not covered" >    err.msg = fluid.stringTemplate(err.msg, termMap);</span>
<span class="cstat-no" title="statement not covered" >    return err;</span>
};
&nbsp;
gpii.oauth2.mapPromiseToResponse = <span class="fstat-no" title="function not covered" >function (promise, response) {</span>
