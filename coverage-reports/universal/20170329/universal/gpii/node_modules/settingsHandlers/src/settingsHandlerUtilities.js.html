  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">59.28% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>99/167</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">31.34% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>21/67</span>
      </div>
      <div class='fl pad1y space-right2'>
...
var fluid = fluid || <span class="branch-1 cbranch-no" title="branch not covered" >require("infusion"),</span>
    fs = typeof(require) === "undefined" ? null : <span class="branch-1 cbranch-no" title="branch not covered" >require("fs"),</span> // courtesy to run web-based tests for partial file contents
...
gpii.invokeLater = function (callback, time) {
    var wrapped = kettle.wrapCallback ? <span class="branch-0 cbranch-no" title="branch not covered" >kettle.wrapCallback(callback) </span>: callback;
...
/** Extract just the settings (eliminating "options") from the nested settingsHandler blocks for a full payload (top-level keys are solution ids)
  ...
  */
&nbsp;
gpii.settingsHandlers.extractSettingsBlocks = <span class="fstat-no" title="function not covered" >function (payload) {</span>
<span class="cstat-no" title="statement not covered" >    return gpii.settingsHandlers.transformPayload(payload, <span class="fstat-no" title="function not covered" >function (oneSolution) {</span></span>
...
&nbsp;
gpii.settingsHandlers.changesPayloadToSettings = <span class="fstat-no" title="function not covered" >function (response) {</span>
 ...
 */
&nbsp;
gpii.settingsHandlers.comparePayloads = <span class="fstat-no" title="function not covered" >function (payload1, payload2) {</span>
<span class="cstat-no" title="statement not covered" >    var settings1 = gpii.settingsHandlers.extractSettingsBlocks(payload1);</span>
<span class="cstat-no" title="statement not covered" >    var settings2 = gpii.settingsHandlers.extractSettingsBlocks(payload2);</span>
<span class="cstat-no" title="statement not covered" >    var equal = fluid.model.diff(settings1, settings2);</span>
...
&nbsp;
gpii.settingsHandlers.checkRereadSettings = <span class="fstat-no" title="function not covered" >function (that) {</span>
<span class="cstat-no" title="statement not covered" >    var writeAttempt = that.retryOptions.rewriteEvery &amp;&amp; (that.retries % that.retryOptions.rewriteEvery === 0);</span>
...
<span class="cstat-no" title="statement not covered" >    var response = gpii.resolveSync(fluid.invokeGlobalFunction(that.resolvedName + (writeAttempt ? ".set" : ".get"), [that.payload]));</span>
<span class="cstat-no" title="statement not covered" >    var getResponse = writeAttempt ? gpii.settingsHandlers.setResponseToSnapshot(response) : response;</span>
<span class="cstat-no" title="statement not covered" >    var equal = gpii.settingsHandlers.comparePayloads(getResponse, that.payload);</span>
<span class="cstat-no" title="statement not covered" >    if (equal) {</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >            gpii.settingsHandlers.invokeRetryingHandler(resolvedName, payload, retryOptions) </span>:
 ...
 */
gpii.settingsHandlers.invokeRetryingHandler = <span class="fstat-no" title="function not covered" >function (resolvedName, payload, retryOptions) {</span>
<span class="cstat-no" title="statement not covered" >    var that = {</span>
        ...
        togo: fluid.promise(),
        checkRereadSettings: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            gpii.settingsHandlers.checkRereadSettings(that);</span>
        }
    };
<span class="cstat-no" title="statement not covered" >    var originalResponse = gpii.settingsHandlers.invokeSetHandler(resolvedName, payload);</span>
<span class="cstat-no" title="statement not covered" >    originalResponse.then(<span class="fstat-no" title="function not covered" >function (setPayload) {</span></span>
 ...
 */
&nbsp;
gpii.settingsHandlers.getSettings = <span class="fstat-no" title="function not covered" >function (solutionEntry, currentSettings) {</span>
<span class="cstat-no" title="statement not covered" >    var newSettingsResponse = {};</span>
<span class="cstat-no" title="statement not covered" >    var userRequestedSettings = solutionEntry.settings;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    fluid.each(userRequestedSettings, <span class="fstat-no" title="function not covered" >function (settingVal, settingKey) {</span></span>
<span class="cstat-no" title="statement not covered" >        var value = fluid.get(currentSettings, settingKey, fluid.model.escapedGetConfig);</span>
...
&nbsp;
    ...
    fluid.each(userRequestedSettings, function (settingVal, settingKey) {
        ...
        change.type = settingVal === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >"DELETE" </span>: "ADD";
...
&nbsp;
gpii.settingsHandlers.readFile = <span class="fstat-no" title="function not covered" >function (options) {</span>
...
<span class="cstat-no" title="statement not covered" >    var content = fs.readFileSync(options.filename, options.encoding || "utf-8");</span>
<span class="cstat-no" title="statement not covered" >    return content;</span>
};
&nbsp;
gpii.settingsHandlers.writeFile = <span class="fstat-no" title="function not covered" >function (content, options) {</span>
<span class="cstat-no" title="statement not covered" >    if (!options || !options.filename) {</span>
 ...
 */
gpii.settingsHandlers.handleFileSolutionEntry = <span class="fstat-no" title="function not covered" >function (solutionEntry, modifier, parser, isWrite) {</span>
<span class="cstat-no" title="statement not covered" >    var options = solutionEntry.options;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        var content = gpii.settingsHandlers.readFile(options);</span>
        // if the file is non-existing, current settings are {}, else they're the parsed content of the file
<span class="cstat-no" title="statement not covered" >        var currentSettings = (content === undefined) ? {} : parser.parse(content, options);</span>
&nbsp;
        // modification of the entry
<span class="cstat-no" title="statement not covered" >        var settings = modifier(solutionEntry, currentSettings);</span>
...
<span class="cstat-no" title="statement not covered" >            var settingsData = parser.stringify(currentSettings, options);</span>
 ...
 * entry.
 */
gpii.settingsHandlers.transformFilePayload = <span class="fstat-no" title="function not covered" >function (payload, modifier, parser, isWrite) {</span>
<span class="cstat-no" title="statement not covered" >    return gpii.settingsHandlers.transformPayload(payload, <span class="fstat-no" title="function not covered" >function (solutionEntry) {</span></span>
...
&nbsp;
gpii.settingsHandlers.makeFileGet = <span class="fstat-no" title="function not covered" >function (parser) {</span>
...
&nbsp;
gpii.settingsHandlers.makeFileSet = <span class="fstat-no" title="function not covered" >function (parser) {</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function (payload) {</span></span>
