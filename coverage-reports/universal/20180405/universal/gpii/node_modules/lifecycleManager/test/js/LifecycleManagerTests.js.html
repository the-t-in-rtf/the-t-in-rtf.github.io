...
&nbsp;
    gpii.tests.lifecycleManager.environmentResolver = <span class="fstat-no" title="function not covered" >fu</span>nction (name) {
<span class="cstat-no" title="statement not covered" >        return gpii.tests.lifecycleManager.fakeEnvironment[name];</span>
    };
&nbsp;
    /**
...
&nbsp;
    ...
    gpii.tests.lifecycleManager.extendLifecycleInstructions = function (currentInstructions) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(currentInstructions).length &lt; 1) {
<span class="cstat-no" title="statement not covered" >            jqUnit.assertTrue("Instructions passed to extendLifecycleInstructions didn't contain an entry as expected", false);</span>
        }
...
&nbsp;
    gpii.tests.lifecycleManager.mockExecHandler = <span class="fstat-no" title="function not covered" >fu</span>nction (command, args) {
<span class="cstat-no" title="statement not covered" >        gpii.tests.lifecycleManager.staticRepository.execHandler = {</span>
            command: command,
            args: args
        };
...
&nbsp;
    gpii.tests.lifecycleManager.mockKillHandler = <span class="fstat-no" title="function not covered" >fu</span>nction (pid) {
<span class="cstat-no" title="statement not covered" >        gpii.tests.lifecycleManager.staticRepository.killHandler = {</span>
            pid: pid
        };
    };
&nbsp;
...
&nbsp;
    gpii.tests.lifecycleManager.assertNoActiveSessions = <span class="fstat-no" title="function not covered" >fu</span>nction (lifecycleManager, message) {
<span class="cstat-no" title="statement not covered" >        jqUnit.assertDeepEq(message + "- session state should be empty", [], lifecycleManager.getActiveSessionTokens());</span>
    };
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Apr 05 2018 09:57:25 GMT+0000 (UTC)
</div>
</div>
