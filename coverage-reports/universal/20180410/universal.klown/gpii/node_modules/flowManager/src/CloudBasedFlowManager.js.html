...
<html lang="en">
<head>
    <title>Code coverage report for universal.klown/gpii/node_modules/flowManager/src/CloudBasedFlowManager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal.klown/gpii/node_modules/flowManager/src</a> CloudBasedFlowManager.js
    </h1>
    <div class='clearfix'>
 ...
 */
gpii.flowManager.cloudBased.matchToUntrustedSettings = <span class="fstat-no" title="function not covered" >fu</span>nction (finalPayload, event) {
    // Note that we send the filtered preferences to assist a PSP - we may do more filtering here at some point
    var settings = <span class="cstat-no" title="statement not covered" >fluid.filterKeys(finalPayload, [</span>
        "userToken", "activeContextName", "preferences",
        "activeConfiguration", "solutionsRegistryEntries", "matchMakerOutput"
    ]);
<span class="cstat-no" title="statement not covered" >    settings.preferences = gpii.matchMakerFramework.utils.filterPreferencesFromInferredConfig(settings.preferences, settings.matchMakerOutput.inferredConfiguration);</span>
<span class="cstat-no" title="statement not covered" >    fluid.log("cloudBased flowManager sending settings ", settings);</span>
<span class="cstat-no" title="statement not covered" >    event.fire(settings);</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
