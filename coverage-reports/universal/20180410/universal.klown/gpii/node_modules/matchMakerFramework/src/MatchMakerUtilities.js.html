...
<html lang="en">
<head>
    <title>Code coverage report for universal.klown/gpii/node_modules/matchMakerFramework/src/MatchMakerUtilities.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal.klown/gpii/node_modules/matchMakerFramework/src</a> MatchMakerUtilities.js
    </h1>
    <div class='clearfix'>
...
<a name='L873'></a><a href='#L873'>873</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-yes">36039x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">6929x</span>
<span class="cline-any cline-yes">6929x</span>
<span class="cline-any cline-yes">4478x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1763x</span>
<span class="cline-any cline-yes">8432x</span>
<span class="cline-any cline-yes">8432x</span>
<span class="cline-any cline-yes">8432x</span>
<span class="cline-any cline-yes">7448x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1763x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">291x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2920x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-yes">4201x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9x</span>
...
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">14275x</span>
<span class="cline-any cline-yes">29872x</span>
<span class="cline-any cline-yes">35208x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">35155x</span>
<span class="cline-any cline-yes">35155x</span>
<span class="cline-any cline-yes">29800x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
        ...
        fluid.each(types, function (type) {
            for (var solutionId in solutionTypeMapping[type]) {
                ...
                if (!sol.disposition) {
                    ...
                    sol.active = false;
                    sol.dispositionReason = disposeReason || <span class="branch-1 cbranch-no" title="branch not covered" >"Solution accepted but deactivated due to its type of " + type;</span>
                }
            }
        });
    };
    ...
    gpii.matchMakerFramework.utils.updateInferredConfiguration = function (preferences, inferredConfiguration, solutionsRegistryEntries) {
        ...
        fluid.each(preferences.contexts, function (contextBlock, contextName) {
            fluid.each(contextBlock.preferences, function (val, pref) {
                ...
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (gpii.matchMakerFramework.utils.isApplicationTerm(pref)) {
            ...
            fluid.each(inferred[contextName].applications, function (solutionBlock, solutionId) {
                var solutionCapabilities = fluid.get(solutionsRegistryEntries, [ solutionId, "capabilities" ]) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Apr 10 2018 10:12:43 GMT+0200 (CEST)
</div>
</div>
