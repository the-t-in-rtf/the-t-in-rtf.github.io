...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/src/UserService.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../index.html">All files</a> / <a href="index.html">universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/src</a> UserService.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    gpii.oauth2.userService.authenticateUser = function (dataStore, username, password) {
        ...
        userPromise.then(function (user) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (user &amp;&amp; user.password === password) {
                promiseTogo.resolve(user);
            } else {
<span class="cstat-no" title="statement not covered" >                promiseTogo.reject(gpii.oauth2.errors.invalidUser);</span>
            }
