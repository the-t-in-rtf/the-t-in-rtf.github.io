...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/flowManager/src/PrivacyFilter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal/gpii/node_modules/flowManager/src</a> PrivacyFilter.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    fluid.each(configurations, function (config, configName) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (config.hasOwnProperty("conditions")) {
            // TODO copy here or re-using reference is fine?
<span class="cstat-no" title="statement not covered" >            filteredConfig.conditions = config.conditions;</span>
        }
