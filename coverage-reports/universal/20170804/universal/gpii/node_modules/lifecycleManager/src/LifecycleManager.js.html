  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>184/212</span>
      </div>
      <div class='fl pad1y space-right2'>
...
679
680
681</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >            fluid.fail("Attempt to get sessions without keys");</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (memberKey === undefined) {
...
&nbsp;
        if (handlerSpec.supportedSettings === undefined) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isMultiSH) {
...
&nbsp;
    ...
    gpii.lifecycleManager.cleanDeletes = function (value) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (value.type === "DELETE") {
            delete value.value;
        }
        return value;
    };
    ...
    gpii.lifecycleManager.executeActions = function (that, solutionId, solutionRecord, session, actionBlock, rootAction) {
        ...
        var sequence = fluid.transform(steps, function (action) {
            if (typeof(action) === "string") {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (action.indexOf("settings.") === 0) {
...
&nbsp;
    ...
    gpii.lifecycleManager.processUpdate = function (that, finalPayload) {
        ...
        var session = that.getSession([userToken]);
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!session) {
<span class="cstat-no" title="statement not covered" >            fluid.fail("User with token " + userToken + " has no active session");</span>
        }
            ...
            tasks.push(function () {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!fluid.isDestroyed(that)) { // See above comment for GPII-580
                    ...
                    return that.applySolution(solutionId, solution, session,
                        (solution.active ? [ "configure", "start" ] : <span class="branch-1 cbranch-no" title="branch not covered" >[ "configure" ])</span>, "start");
                }
            });
        });
