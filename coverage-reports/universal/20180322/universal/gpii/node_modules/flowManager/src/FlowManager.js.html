...
&nbsp;
&nbsp;
gpii.flowManager.mountWebSocketsSettingsHandler = <span class="fstat-no" title="function not covered" >fu</span>nction (webSocketsSettingsHandlerComponent) {
<span class="cstat-no" title="statement not covered" >    gpii.settingsHandlers.webSockets.instance = webSocketsSettingsHandlerComponent;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
