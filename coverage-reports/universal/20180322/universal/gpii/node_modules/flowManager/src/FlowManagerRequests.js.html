  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">30.61% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>15/49</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    gpii.logFully = <span class="fstat-no" title="function not covered" >fu</span>nction () {
        var oldRenderChars = <span class="cstat-no" title="statement not covered" >fluid.logObjectRenderChars;</span>
<span class="cstat-no" title="statement not covered" >        fluid.logObjectRenderChars = 2 &lt;&lt; 20;</span>
<span class="cstat-no" title="statement not covered" >        fluid.log.apply(null, arguments);</span>
<span class="cstat-no" title="statement not covered" >        fluid.logObjectRenderChars = oldRenderChars;</span>
    };
&nbsp;
     ...
     */
    gpii.renderMegapayload = <span class="fstat-no" title="function not covered" >fu</span>nction (megapayload) {
        var solutionsRegistryEntries = <span class="cstat-no" title="statement not covered" >fluid.transform(megapayload.solutionsRegistryEntries, <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >            return "&lt;consult solutions registry for full contents&gt;";</span>
        });
<span class="cstat-no" title="statement not covered" >        return fluid.extend({}, megapayload, {</span>
...
&nbsp;
    gpii.flowManager.getPreferences = <span class="fstat-no" title="function not covered" >fu</span>nction (preferencesDataSource, request, event, userToken) {
<span class="cstat-no" title="statement not covered" >        fluid.log("gpii.flowManager.getPreferences called - fetching preferences from URL " + preferencesDataSource.options.url);</span>
        var promise = <span class="cstat-no" title="statement not covered" >preferencesDataSource.get({userToken: userToken});</span>
...
<span class="cstat-no" title="statement not covered" >            event.fire(data.preferences || data);</span>
        }, <span class="fstat-no" title="function not covered" >fu</span>nction (err) {
<span class="cstat-no" title="statement not covered" >            err.message = "Error when retrieving preferences: " + err.message;</span>
<span class="cstat-no" title="statement not covered" >            request.events.onError.fire(err);</span>
        });
    };
&nbsp;
    /*
     ...
     */
    gpii.flowManager.getSolutions = <span class="fstat-no" title="function not covered" >fu</span>nction (solutionsRegistryDataSource, deviceContext, event, onError) {
        var os = <span class="cstat-no" title="statement not covered" >fluid.get(deviceContext, "OS.id");</span>
        var promise = <span class="cstat-no" title="statement not covered" >solutionsRegistryDataSource.get({});</span>
<span class="cstat-no" title="statement not covered" >        promise.then(<span class="fstat-no" title="function not covered" >fu</span>nction (solutions) {</span>
            var solutionsRegistryEntries = <span class="cstat-no" title="statement not covered" >gpii.matchMakerFramework.filterSolutions(solutions[os], deviceContext);</span>
<span class="cstat-no" title="statement not covered" >            fluid.log("Fetched filtered solutions registry entries: ", gpii.renderMegapayload({solutionsRegistryEntries: solutionsRegistryEntries}));</span>
<span class="cstat-no" title="statement not covered" >            event.fire(solutionsRegistryEntries, solutions);</span>
        }, onError.fire);
    };
&nbsp;
    ...
    gpii.flowManager.processMatch = <span class="fstat-no" title="function not covered" >fu</span>nction (that, initialPayload) {
        var promise = <span class="cstat-no" title="statement not covered" >fluid.promise.fireTransformEvent(that.events.processMatch, initialPayload, {});</span>
<span class="cstat-no" title="statement not covered" >        promise.then(<span class="fstat-no" title="function not covered" >fu</span>nction (finalPayload) {</span>
<span class="cstat-no" title="statement not covered" >            that.events.onMatchDone.fire(finalPayload);</span>
...
&nbsp;
&nbsp;
    gpii.flowManager.setUserToken = <span class="fstat-no" title="function not covered" >fu</span>nction (handler, userToken) {
<span class="cstat-no" title="statement not covered" >        handler.userToken = userToken;</span>
    };
&nbsp;
...
&nbsp;
    gpii.flowManager.sessionAware.withSession = <span class="fstat-no" title="function not covered" >fu</span>nction (that, lifecycleManager, onSuccess, failMessage, onError) {
<span class="cstat-no" title="statement not covered" >        onError = onError || that.events.onError.fire;</span>
        var userTokens = <span class="cstat-no" title="statement not covered" >that.getActiveSessionTokens();</span>
<span class="cstat-no" title="statement not covered" >        if (userTokens.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >            failMessage = failMessage || "Error handling request which required active session, but none was active";</span>
<span class="cstat-no" title="statement not covered" >            onError({</span>
            ...
            var session = <span class="cstat-no" title="statement not covered" >lifecycleManager.getSession(userTokens);</span>
<span class="cstat-no" title="statement not covered" >            onSuccess(session, userTokens);</span>
        }
    };
&nbsp;
})();
