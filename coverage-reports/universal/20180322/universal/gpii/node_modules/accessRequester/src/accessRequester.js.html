...
&nbsp;
gpii.accessRequester.getAccessToken = <span class="fstat-no" title="function not covered" >fu</span>nction (clientCredentialDataSource, accessTokenDataSource, userToken) {
    var promiseTogo = <span class="cstat-no" title="statement not covered" >fluid.promise();</span>
    var clientCredentialPromise = <span class="cstat-no" title="statement not covered" >clientCredentialDataSource.get();</span>
<span class="cstat-no" title="statement not covered" >    clientCredentialPromise.then(<span class="fstat-no" title="function not covered" >fu</span>nction (clientCredential) {</span>
        var accessTokenRequestParams = <span class="cstat-no" title="statement not covered" >$.extend({}, accessTokenDataSource.options.dataSourceModel, clientCredential, {</span>
            username: userToken
        });
        var accessTokenPromise = <span class="cstat-no" title="statement not covered" >accessTokenDataSource.set(null, accessTokenRequestParams);</span>
