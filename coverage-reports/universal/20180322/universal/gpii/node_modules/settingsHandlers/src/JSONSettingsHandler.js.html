...
&nbsp;
parser.parse = <span class="fstat-no" title="function not covered" >fu</span>nction (content) {
<span class="cstat-no" title="statement not covered" >    return JSON.parse(content);</span>
};
&nbsp;
parser.stringify = <span class="fstat-no" title="function not covered" >fu</span>nction (content) {
<span class="cstat-no" title="statement not covered" >    return fluid.prettyPrintJSON(content);</span>
};
&nbsp;
