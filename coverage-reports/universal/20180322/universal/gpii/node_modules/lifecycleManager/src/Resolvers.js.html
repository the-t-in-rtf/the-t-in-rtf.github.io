...
&nbsp;
    gpii.lifecycleManager.variableResolver.computeResolvers = <span class="fstat-no" title="function not covered" >fu</span>nction (resolvers) {
<span class="cstat-no" title="statement not covered" >        return fluid.transform(resolvers, fluid.getGlobalValue);</span>
    };
&nbsp;
    gpii.lifecycleManager.variableResolver.resolve = <span class="fstat-no" title="function not covered" >fu</span>nction (material, fetcher, extraFetcher) {
        // TODO: This relies on a horribly undocumented and unstable Infusion API
<span class="cstat-no" title="statement not covered" >        return fluid.expand(material, {</span>
...
&nbsp;
     ...
     */
&nbsp;
    gpii.resolversToFetcher = <span class="fstat-no" title="function not covered" >fu</span>nction (resolvers) {
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (parsed) {</span>
            var resolver = <span class="cstat-no" title="statement not covered" >resolvers[parsed.context];</span>
<span class="cstat-no" title="statement not covered" >            return !resolver ? undefined : (</span>
...
&nbsp;
     ...
     * into a single one
     */
    gpii.combineFetchers = <span class="fstat-no" title="function not covered" >fu</span>nction (main, fallback) {
<span class="cstat-no" title="statement not covered" >        return fallback ? <span class="fstat-no" title="function not covered" >fu</span>nction (parsed) {</span>
            var fetched = <span class="cstat-no" title="statement not covered" >main(parsed);</span>
<span class="cstat-no" title="statement not covered" >            return fetched === undefined ? fallback(parsed) : fetched;</span>
        } : main;
    };
&nbsp;
