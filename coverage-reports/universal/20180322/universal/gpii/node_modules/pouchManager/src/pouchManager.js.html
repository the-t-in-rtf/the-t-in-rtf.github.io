...
&nbsp;
gpii.pouchManager.recreatePouchHarness = <span class="fstat-no" title="function not covered" >fu</span>nction (pouchManager) {
<span class="cstat-no" title="statement not covered" >    if (pouchManager.recreatePouchHarnessAfterDestroy) {</span>
<span class="cstat-no" title="statement not covered" >        pouchManager.events.onCreatePouchHarness.fire();</span>
<span class="cstat-no" title="statement not covered" >        pouchManager.events.onPouchHarnessRecreated.fire();</span>
<span class="cstat-no" title="statement not covered" >        pouchManager.recreatePouchHarnessAfterDestroy = false;</span>
    }
};
&nbsp;
...
&nbsp;
gpii.pouchManager.reset.handler.reset = <span class="fstat-no" title="function not covered" >fu</span>nction (that, pouchManager) {
<span class="cstat-no" title="statement not covered" >    pouchManager.recreatePouchHarnessAfterDestroy = true;</span>
    var cleanupPromise = <span class="cstat-no" title="statement not covered" >pouchManager.pouchHarness.express.expressPouch.cleanup();</span>
&nbsp;
    // The success call back is unnecessary here, which is substituted by the onCleanupComplete listener.
<span class="cstat-no" title="statement not covered" >    cleanupPromise.then(null, <span class="fstat-no" title="function not covered" >fu</span>nction (err) {</span>
