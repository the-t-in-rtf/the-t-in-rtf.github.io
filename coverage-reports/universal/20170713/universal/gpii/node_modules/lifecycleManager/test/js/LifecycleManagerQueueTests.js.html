...
&nbsp;
        queuePromise.then(<span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
        ...
        // next task fails
        lifecycleManager.addToQueue(failTask).then(<span class="fstat-no" title="function not covered" >function () {</span>
