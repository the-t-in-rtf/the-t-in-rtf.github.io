...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/public/src/components/selectionTree/js/SelectionTree.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../../../../../../index.html">all files</a> / <a href="index.html">universal/gpii/node_modules/gpii-oauth2/gpii-oauth2-authz-server/public/src/components/selectionTree/js/</a> SelectionTree.js
    </h1>
    <div class='clearfix'>
...
<a name='L470'></a><a href='#L470'>470</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    gpii.oauth2.selectionTree.bindDOMListener = function (that, elm, ELPath, updateModelFn) {
        elm.change(<span class="fstat-no" title="function not covered" >function (e) {</span>
<span class="cstat-no" title="statement not covered" >            var state = $(e.target).prop("checked") ? "checked" : "unchecked";</span>
<span class="cstat-no" title="statement not covered" >            updateModelFn(ELPath, state);</span>
        });
    };
&nbsp;
    gpii.oauth2.selectionTree.relayClick = <span class="fstat-no" title="function not covered" >function (elm) {</span>
<span class="cstat-no" title="statement not covered" >        $(elm).click();</span>
    };
&nbsp;
    gpii.oauth2.selectionTree.toggleClass = <span class="fstat-no" title="function not covered" >function (elm, classes, state) {</span>
<span class="cstat-no" title="statement not covered" >        $(elm).toggleClass(classes, state);</span>
    };
&nbsp;
