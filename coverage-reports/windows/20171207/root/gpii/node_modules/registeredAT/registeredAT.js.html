...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.configOnly) {
        if (enable) {
...
&nbsp;
    ...
    if (enable &amp;&amp; !options.configOnly) {
        ...
        gpii.windows.whilePendingAT().then(function () {
            var targetValue = enable ? <span class="branch-0 cbranch-no" title="branch not covered" >gpii.windows.API_constants.enableAT </span>: gpii.windows.API_constants.disableAT;
...
<span class="cstat-no" title="statement not covered" >        command = options.startCommand;</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options &amp;&amp; options.atInfo) {
<span class="cstat-no" title="statement not covered" >            atInfo = fluid.extend(atInfo, options.atInfo);</span>
        }
        command = atInfo.StartExe;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (atInfo.StartParams !== undefined) {
<span class="cstat-no" title="statement not covered" >            command += " " + atInfo.StartParams;</span>
        }
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (atInfo.CopySettingsToLockedDesktop) {
