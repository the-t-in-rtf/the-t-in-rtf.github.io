...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/windowsMetrics/test/WindowsMetricsTests.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/windowsMetrics/test</a> WindowsMetricsTests.js
    </h1>
    <div class='clearfix'>
...
871
872
873</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
gpii.tests.metrics.deepMatch = function (subject, expected, maxDepth) {
    var match = false;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (maxDepth &lt; 0) {
<span class="cstat-no" title="statement not covered" >        return false;</span>
    } else if (!maxDepth &amp;&amp; maxDepth !== 0) {
        maxDepth = fluid.strategyRecursionBailout;
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!subject) {
<span class="cstat-no" title="statement not covered" >        return subject === expected;</span>
    }
&nbsp;
    for (var prop in expected) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (expected.hasOwnProperty(prop)) {
...
&nbsp;
    ...
    var complete = false;
&nbsp;
    reader.input.on("error", <span class="fstat-no" title="function not covered" >fu</span>nction (err) {
<span class="cstat-no" title="statement not covered" >        jqUnit.fail(err);</span>
    });
&nbsp;
...
&nbsp;
    reader.on("close", function () {
        reader.input.close();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (complete) {
            promise.resolve();
        } else {
<span class="cstat-no" title="statement not covered" >            fluid.log("No matching line (index=" + index + "):", currentExpected);</span>
<span class="cstat-no" title="statement not covered" >            fluid.log("Remaining log lines:", remainingLines);</span>
<span class="cstat-no" title="statement not covered" >            promise.reject("Unable to find matching log entry " + index);</span>
        }
    });
&nbsp;
    return promise;
