...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/registrySettingsHandler/test/testRegistrySettingsHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/registrySettingsHandler/test</a> testRegistrySettingsHandler.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        jqUnit.fail("Should not fail.");</span>
...
&nbsp;
    var testValue = "test";
    var bits = (os.arch() === "x64") ? <span class="branch-0 cbranch-no" title="branch not covered" >"64" </span>: "32";
&nbsp;
    // 32-bit read/write
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (gpii.windows.isWow64() || <span class="branch-1 cbranch-no" title="branch not covered" >bits === "64")</span> {
...
&nbsp;
        ...
        var otherBits = (bits === "64") ? <span class="branch-0 cbranch-no" title="branch not covered" >"32" </span>: "64";
