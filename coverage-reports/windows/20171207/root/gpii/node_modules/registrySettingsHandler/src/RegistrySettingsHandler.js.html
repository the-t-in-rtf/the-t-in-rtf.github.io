  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.64% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>155/171</span>
      </div>
      <div class='fl pad1y space-right2'>
...
windows.registryTypes.REG_BINARY = {
    code: 3,
    readConvert: <span class="fstat-no" title="function not covered" >fu</span>nction (pointer, count) {
<span class="cstat-no" title="statement not covered" >        return gpii.pointerToHex(pointer, count);</span>
    },
    writeConvert: <span class="fstat-no" title="function not covered" >fu</span>nction (value) {
<span class="cstat-no" title="statement not covered" >        return gpii.hexToPointer(value);</span>
    }
};
&nbsp;
...
&nbsp;
    ...
    if (path[2] === ":") {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (bits === "64") {
            togo.desiredAccess |= c.KEY_WOW64_64KEY;
        } else <span class="cstat-no" title="statement not covered" >if (bits === "32") {</span>
<span class="cstat-no" title="statement not covered" >            togo.desiredAccess |= c.KEY_WOW64_32KEY;</span>
        }
&nbsp;
...
windows.openRegistryKey = function (baseKey, path, keyHolder) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (code === windows.API_constants.returnCodes.FILE_NOT_FOUND) {
...
<span class="cstat-no" title="statement not covered" >        fluid.fail("Unsupported registry type " + type);</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (openError) {
<span class="cstat-no" title="statement not covered" >        return openError;</span>
    }
&nbsp;
    try {
...
&nbsp;
    try {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (value === undefined &amp;&amp; code2 === windows.API_constants.returnCodes.FILE_NOT_FOUND) { // Do not fail if delete was requested for nonexistent key
...
windows.deleteRegistryKey = function (baseKey, path) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (code !== windows.API_constants.returnCodes.FILE_NOT_FOUND) {
        cr(code);
    }
};
&nbsp;
