...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/displaySettingsHandler/test/testDisplaySettingsHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/displaySettingsHandler/test</a> testDisplaySettingsHandler.js
    </h1>
    <div class='clearfix'>
...
gpii.tests.displaySettings.resolveReferences = function (model, value) {
    if (typeof(value) === "string") {
        return value.charAt(0) === "$" ? fluid.get(model, value.substring(1)) : <span class="branch-1 cbranch-no" title="branch not covered" >value;</span>
    } else {
...
jqUnit.test("Testing setScreenDpi ", function () {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (res.width &lt; 1024 || <span class="branch-1 cbranch-no" title="branch not covered" >res.height &lt; 768)</span> {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Dec 07 2017 03:04:40 GMT-0800 (Pacific Standard Time)
</div>
</div>
