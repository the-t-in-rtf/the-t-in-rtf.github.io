  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>135/197</span>
      </div>
      <div class='fl pad1y space-right2'>
...
861
862
863</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
windows.EnumWindowsProc = <span class="fstat-no" title="function not covered" >fu</span>nction (callback) {
<span class="cstat-no" title="statement not covered" >    return ffi.Callback(t.BOOL, [t.HANDLE, t.HANDLE], callback);</span>
};
&nbsp;
...
&nbsp;
gpii.pointerToHex = <span class="fstat-no" title="function not covered" >fu</span>nction (pointer, count) {
...
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; count; ++i) {</span>
        var nbyte = <span class="cstat-no" title="statement not covered" >pointer.readUInt8(i);</span>
<span class="cstat-no" title="statement not covered" >        togo += (nbyte &lt; 16 ? "0" : "") + nbyte.toString(16);</span>
<span class="cstat-no" title="statement not covered" >        if (i !== count - 1) {</span>
<span class="cstat-no" title="statement not covered" >            togo += " ";</span>
        }
    }
...
gpii.hexToPointer = <span class="fstat-no" title="function not covered" >fu</span>nction (hexString) {
    var buffer = <span class="cstat-no" title="statement not covered" >[];</span>
    var i;
<span class="cstat-no" title="statement not covered" >    for (i = 0; i &lt; hexString.length; ++i) {</span>
        var c = <span class="cstat-no" title="statement not covered" >hexString.charAt(i);</span>
        var digit = <span class="cstat-no" title="statement not covered" >parseInt(c, 16);</span>
<span class="cstat-no" title="statement not covered" >        if (!isNaN(digit)) {</span>
<span class="cstat-no" title="statement not covered" >            buffer.push(digit);</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if ((buffer.length % 2) === 1) {</span>
<span class="cstat-no" title="statement not covered" >        fluid.fail("Odd number of hex digits in buffer " + hexString);</span>
    }
&nbsp;
    var togo = <span class="cstat-no" title="statement not covered" >new Buffer(buffer.length / 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (i = 0; i &lt; buffer.length; i += 2) {</span>
<span class="cstat-no" title="statement not covered" >        togo.writeUInt8(buffer[i] * 16 + buffer[i + 1], i / 2);</span>
    }
 ...
 */
windows.stringToWideChar = <span class="fstat-no" title="function not covered" >fu</span>nction (string) {
<span class="cstat-no" title="statement not covered" >    return new Buffer(string + "\u0000", "ucs2"); </span>// add null at the end
};
&nbsp;
windows.stringFromWideChar = <span class="fstat-no" title="function not covered" >fu</span>nction (buffer) {
<span class="cstat-no" title="statement not covered" >    return ref.reinterpretUntilZeros(buffer, 2, 0).toString("ucs2");</span>
};
&nbsp;
/*
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (struct.cbSize !== undefined) {
        ...
        // Windows XP/2000
        <span class="missing-if-branch" title="if path not taken" >I</span>if (structName === "NONCLIENTMETRICS" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >os.release() &lt; "6")</span> {
<span class="cstat-no" title="statement not covered" >            struct.cbSize -= 4; </span>// do not unclude NONCLIENTMETRICS.iPaddedBorderWidth
        }
    }
&nbsp;
    return struct;
...
&nbsp;
        ...
        if (setValue !== undefined) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof setValue === "string") {
<span class="cstat-no" title="statement not covered" >                setValue = windows.stringToWideChar(setValue);</span>
            }
            fluid.set(object, path, setValue);
        }
&nbsp;
        var value = fluid.get(object, path);
        return Buffer.isBuffer(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >windows.stringFromWideChar(value) </span>: value;
    }
};
&nbsp;
/**
 ...
 */
windows.arrayToBuffer = <span class="fstat-no" title="function not covered" >fu</span>nction (array, type) {
    var size = <span class="cstat-no" title="statement not covered" >ref.coerceType(windows.types[type]).size;</span>
    var buf = <span class="cstat-no" title="statement not covered" >new Buffer(array.length * size);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; array.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        ref.set(buf, i * size, array[i], windows.types[type]);</span>
    }
&nbsp;
 ...
 */
windows.bufferToArray = <span class="fstat-no" title="function not covered" >fu</span>nction (buffer, type) {
    var array = <span class="cstat-no" title="statement not covered" >[];</span>
    var size = <span class="cstat-no" title="statement not covered" >ref.coerceType(windows.types[type]).size;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; buffer.length / size; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        array[i] = ref.get(buffer, i * size, windows.types[type]);</span>
    }
&nbsp;
 ...
 */
windows.enumerateWindows = <span class="fstat-no" title="function not covered" >fu</span>nction (callback) {
    // Suppress "no-unused-vars" - lparam argument is required for EnumWindowsProc.
    // eslint-disable-next-line no-unused-vars
    var proc = <span class="cstat-no" title="statement not covered" >gpii.windows.EnumWindowsProc(<span class="fstat-no" title="function not covered" >fu</span>nction (hwnd, lparam) {</span>
<span class="cstat-no" title="statement not covered" >        callback(hwnd);</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    gpii.windows.user32.EnumWindows(proc, 0);</span>
};
&nbsp;
/**
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (timeTakenMs &gt;= options.timeout) {
<span class="cstat-no" title="statement not covered" >                    timedout = true;</span>
<span class="cstat-no" title="statement not covered" >                    if (options.dontReject) {</span>
<span class="cstat-no" title="statement not covered" >                        promise.resolve("timeout");</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        promise.reject(options.error);</span>
                    }
                }
            }
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!timedout) {
