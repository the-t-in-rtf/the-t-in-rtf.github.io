...
<html lang="en">
<head>
    <title>Code coverage report for gpii\node_modules\processHandling\test\testProcessHandling.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">gpii/node_modules/processHandling/test/</a> testProcessHandling.js
    </h1>
    <div class='clearfix'>
...
jqUnit.module("gpii.tests.windows.processHandling", {
    ...
    teardown: function () {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (waitExePath !== null) {
...
<span class="cstat-no" title="statement not covered" >            jqUnit.fail("The process '" + exe + "' should not be running");</span>
        }, function () {
...
&nbsp;
    ...
    gpii.windows.waitForProcessTermination(exe, { timeout: 100 })
        .then(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            jqUnit.fail("The process '" + exe + "' should not have terminated");</span>
        }, function () {
            jqUnit.assert("Should have timed out");
            jqUnit.start();
        });
...
<span class="cstat-no" title="statement not covered" >                    jqUnit.fail("Failed to detect process termination.");</span>
                });
&nbsp;
            // Tell the process to stop now.
            child_process.execSync("waitfor /SI waitForProcessTerminationTest");
        }, <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            jqUnit.fail("Failed to detect process start.");</span>
        });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    fluid.log(e.message);</span>
<span class="cstat-no" title="statement not covered" >                    jqUnit.fail("Process should have closed.");</span>
<span class="cstat-no" title="statement not covered" >                    gpii.windows.killProcessByName(exeName);</span>
                });
        }
    });
});
...
&nbsp;
            ...
            gpii.windows.closeProcessByName(waitExe, {cleanOnly: true})
                .then(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                    jqUnit.fail("Process should not have closed.");</span>
                }, function (e) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jul 17 2017 06:10:27 GMT-0700 (Pacific Daylight Time)
</div>
</div>
