...
<html lang="en">
<head>
    <title>Code coverage report for sync/gpii/node_modules/alsa/alsa_bridge.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">sync/gpii/node_modules/alsa/</a> alsa_bridge.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
gpii.alsa.setSystemVolume = <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >    return alsa.setSystemVolume(value);</span>
};
&nbsp;
...
gpii.alsa.getImpl = function (settingsRequest) {
    settingsRequest = settingsRequest || <span class="branch-1 cbranch-no" title="branch not covered" >gpii.alsa.allSettings;</span>
...
<span class="cstat-no" title="statement not covered" >            fluid.fail("Invalid key to ALSA settings handler - " +</span>
