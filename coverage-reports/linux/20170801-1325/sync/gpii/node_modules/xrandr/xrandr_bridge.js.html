...
gpii.xrandr.setScreenResolution = function (value) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (JSON.stringify(value) === JSON.stringify(current)) {
        return true;
    } else {
...
gpii.xrandr.getImpl = function (settingsRequest) {
    settingsRequest = settingsRequest || <span class="branch-1 cbranch-no" title="branch not covered" >gpii.xrandr.allSettings;</span>
    var settings = fluid.transform(settingsRequest, function (value, key) {
        var funcEntry = gpii.xrandr.allSettings[key];
        <span class="missing-if-branch" title="else path not taken" >E</span>if (funcEntry) {
...
&nbsp;
                var oldValue;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (settingKey === "screen-resolution") {
