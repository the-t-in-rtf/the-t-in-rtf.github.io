...
<html lang="en">
<head>
    <title>Code coverage report for sync/gpii/node_modules/orca/orcaSettingsHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">sync/gpii/node_modules/orca/</a> orcaSettingsHandler.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            var rej = {</span>
                isError: true,
                message: "Unable to read Orca settings file: " + err
            };
<span class="cstat-no" title="statement not covered" >            togo.reject(rej);</span>
        }
    };
&nbsp;
    try {
...
<span class="cstat-no" title="statement not covered" >        var makeConfigurable = that.makeConfigurable();</span>
<span class="cstat-no" title="statement not covered" >        makeConfigurable.then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            performRead();</span>
        }, <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >            togo.reject(err);</span>
        });
    }
&nbsp;
    return togo;
...
&nbsp;
gpii.orca.settingsHandler.makeConfigurable = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    var togo = fluid.promise();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var orcaSpawn = spawn("orca", ORCA_ARGS);</span>
<span class="cstat-no" title="statement not covered" >    var pass = 0;</span>
<span class="cstat-no" title="statement not covered" >    var maxPass = 10;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var checkIfFileGetsCreated = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        pass++;</span>
<span class="cstat-no" title="statement not covered" >        if (pass === maxPass) {</span>
<span class="cstat-no" title="statement not covered" >            orcaSpawn.kill("SIGKILL");</span>
<span class="cstat-no" title="statement not covered" >            var err = "Time limit exceeded [" + maxPass * 500 +</span>
...
<span class="cstat-no" title="statement not covered" >                fs.statSync(orcaSettingsFile);</span>
<span class="cstat-no" title="statement not covered" >                orcaSpawn.kill("SIGKILL");</span>
<span class="cstat-no" title="statement not covered" >                togo.resolve();</span>
            } catch (err) {
<span class="cstat-no" title="statement not covered" >                gpii.invokeLater(checkIfFileGetsCreated, 500);</span>
            }
        }
    };
&nbsp;
