...
<html lang="en">
<head>
    <title>Code coverage report for sync/gpii/node_modules/packagekit/nodepackagekit/nodepackagekit_test.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">all files</a> / <a href="index.html">sync/gpii/node_modules/packagekit/nodepackagekit/</a> nodepackagekit_test.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">121676×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
gpii.tests.packageKit.findPackageByName = function (name, pkgArray) {
    return fluid.find(pkgArray, function (aPkg) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (aPkg.name === name) {
            return aPkg;
        }
    }, null);
};
...
gpii.tests.packageKit.availableNotInstalled = function (tuxguitar, availablePkgs) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (tuxguitar.inInstalledList &amp;&amp; isAvailable) {
        var installedMatchesAvailablePkg =
        gpii.tests.packageKit.getMatchingPackage(tuxguitar.pkg, availablePkgs);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (installedMatchesAvailablePkg !== null) {
            tuxguitar.inAvailableList = false;
        }
        else {
<span class="cstat-no" title="statement not covered" >            tuxguitar.inAvailableList = true;</span>
        }
    }
    else {
<span class="cstat-no" title="statement not covered" >        tuxguitar.inAvailableList = isAvailable;</span>
    }
};
&nbsp;
...
gpii.tests.packageKit.runInstalledVsAvailableTests = function (tuxguitar, msg) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (gpii.tests.packageKit.isInstalled(tuxguitar.pkg)) {
...
<span class="cstat-no" title="statement not covered" >        jqUnit.assertFalse(msg + " 'tuxguitar' not in installed packages " +</span>
                           "list", tuxguitar.inInstalledList);
<span class="cstat-no" title="statement not covered" >        jqUnit.assertTrue(msg + " 'tuxguitar' is in available packages list",</span>
...
gpii.tests.packageKit.testRemovePackage = function (tuxguitar, matchPkg) {
    var id = (matchPkg !== null ? <span class="branch-0 cbranch-no" title="branch not covered" >matchPkg.id </span>: tuxguitar.pkg.id);
&nbsp;
...
gpii.tests.packageKit.testInstallPackage = function (tuxguitar, matchPkg) {
    var id = (matchPkg !== null ? matchPkg.id : <span class="branch-1 cbranch-no" title="branch not covered" >tuxguitar.pkg.id)</span>;
...
<span class="cstat-no" title="statement not covered" >        matchPkg = gpii.tests.packageKit.testInstallPackage(tuxguitar, null);</span>
<span class="cstat-no" title="statement not covered" >        gpii.tests.packageKit.testRemovePackage(tuxguitar, matchPkg);</span>
    }
});
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pkgs.length === 2 &amp;&amp;
        (<span class="branch-1 cbranch-no" title="branch not covered" >pkgs[0].version === oldEmacspeak </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >         pkgs[1].version === newEmacspeak </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >         pkgs[1].data.indexOf("updates") !== -1)</span>) {
&nbsp;
<span class="cstat-no" title="statement not covered" >        packagekit.updatePackage(pkgs[1].id);</span>
<span class="cstat-no" title="statement not covered" >        var currentPkgs = packagekit.searchPackage("emacspseak", "installed");</span>
<span class="cstat-no" title="statement not covered" >        jqUnit.assertEquals("Updating to " + newEmacspeak,</span>
                            currentPkgs[0].version, newEmacspeak);
&nbsp;
        // Restore to previous.
<span class="cstat-no" title="statement not covered" >        packagekit.removePackage(currentPkgs[0].id);</span>
    }
    else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Oct 12 2017 11:58:40 GMT+0000 (UTC)
</div>
</div>
