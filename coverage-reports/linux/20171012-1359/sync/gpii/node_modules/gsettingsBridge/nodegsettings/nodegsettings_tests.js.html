...
<html lang="en">
<head>
    <title>Code coverage report for sync/gpii/node_modules/gsettingsBridge/nodegsettings/nodegsettings_tests.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">all files</a> / <a href="index.html">sync/gpii/node_modules/gsettingsBridge/nodegsettings/</a> nodegsettings_tests.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    jqUnit.assertTrue("Setting the value should succeed...", ret);
&nbsp;
...
&nbsp;
    ...
    jqUnit.assertTrue("We can set the value back to its previous value...", ret);
&nbsp;
...
&nbsp;
    ...
    jqUnit.assertTrue("Resetting the value should succeed...", ret2);
...
&nbsp;
    ...
    jqUnit.assertTrue("Setting the value should succeed...", ret3);
});
&nbsp;
jqUnit.test("Test getting and setting string values...", function () {
    ...
    jqUnit.assertTrue("Setting the value should succeed...", ret2);
});
&nbsp;
...
jqUnit.test("Test listing keys...", function () {
    ...
    jqUnit.assertTrue("Requesting a list of keys should return the correct type of variable...", Array.isArray(keys));
&nbsp;
