...
<html lang="en">
<head>
    <title>Code coverage report for sync/gpii/node_modules/gsettingsBridge/gsettings_bridge.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">sync/gpii/node_modules/gsettingsBridge/</a> gsettings_bridge.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
            if (settings === null) {
                ...
                for (var settingKey in settings) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (keys.indexOf(settingKey) === -1) {
